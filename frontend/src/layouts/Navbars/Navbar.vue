...
const minimizeSidebar = () => store.minimizeSidebar();
            ...
            <div class="mt-2 collapse navbar-collapse mt-sm-0 me-md-0 me-sm-4" id="navbar">
                ...
                <ul class="navbar-nav justify-content-end">
                    <li class="nav-item d-flex align-items-center">
                        <router-link to="/" class="px-0 nav-link font-weight-bold text-white"                            >
                    ...
                    <li class="nav-item dropdown d-flex align-items-centerpe-2">
                        <a href="#" class="p-0 nav-link text-white" :class="[showMenu ? 'show' : '']"
