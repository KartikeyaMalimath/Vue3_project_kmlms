    ...
    <v-row>
      <v-col class="12" sm="3">
        <v-sheet class="position-sticky top-0 bg-transparent">
          ...
          <v-card-title
            ...
            @click="navigateRouter('ManageEnterprises')"
            exact
            link
          >
      ...
      <v-col col="12" sm="9">
                ...
                <tbody>
                  <tr>
                    ...
                    <td colspan="3">
                      <template v-if="isEditing">
                        <v-text-field
                          v-model="enterpriseData.details.name"
                          hide-details="auto"
                          variant="underlined"
                          dense
                  ...
                  <tr>
                    ...
                    <td width="30%">
                      <template v-if="isEditing">
                        <v-text-field
                          v-model="enterpriseData.details.addressLine1"
                          hide-details="auto"
                          variant="underlined"
                          dense
                          class="no-padding small-text-field"
                    ...
                    <td width="30%">
                      <template v-if="isEditing">
                        <v-text-field
                          v-model="enterpriseData.details.primaryContact"
                          hide-details="auto"
                          variant="underlined"
                          dense
                          class="no-padding small-text-field"
                  ...
                  <tr>
                    ...
                    <td>
                      <template v-if="isEditing">
                        <v-text-field
                          v-model="enterpriseData.details.addressLine2"
                          hide-details="auto"
                          variant="underlined"
                          dense
                          class="no-padding small-text-field"
                    ...
                    <td>
                      <template v-if="isEditing">
                        <v-text-field
                          v-model="enterpriseData.details.secondaryContact"
                          hide-details="auto"
                          variant="underlined"
                          dense
                          class="no-padding small-text-field"
                  ...
                  <tr>
                    ...
                    <td>
                      <template v-if="isEditing">
                        <v-text-field
                          v-model="enterpriseData.details.city"
                          hide-details="auto"
                          variant="underlined"
                          dense
                          class="no-padding small-text-field"
                  ...
                  <tr>
                    ...
                    <td>
                      <template v-if="isEditing">
                        <v-autocomplete
                          v-model="enterpriseData.details.country"
                          variant="underlined"
                          :items="['India', 'United Kingdom']"
                        ></v-autocomplete>
                      </template>
                      <template v-else>
                  ...
                  <tr>
                    ...
                    <td>
                      <template v-if="isEditing">
                        <v-text-field
                          v-model="enterpriseData.details.postcode"
                          hide-details="auto"
                          variant="underlined"
                          dense
                          class="no-padding small-text-field"
        ...
        <v-card id="ent-users-card">
          ...
          <v-card-text>
            <v-data-table
              :loading="entpUserLoading"
              loading-text="Loading... Please wait"
              :headers="userHeaders"
              :items="enterpriseUsers"
            >
